...
public class HuntKillTest extends MazeTest {
    ...
    public void generate() throws Exception {
        ...
        for (MazeTest.Scenario scenario : MazeTest.Scenario.values()) {
            ...
            //create our maze
            HuntKill maze = new HuntKill(scenario.isHexagon(), scenario.getCols(), scenario.getRows());
            ...
            while (!maze.isGenerated()) {
                ...
                DebugHelper.logEvent("Maze generation progress: HuntKill " + maze.getProgress().getProgress());
