...
public class PrimsTest extends MazeTest {
    ...
    public void generate() throws Exception {
        ...
        for (MazeTest.Scenario scenario : MazeTest.Scenario.values()) {
            ...
            //create our maze
            Prims maze = new Prims(scenario.isHexagon(), scenario.getCols(), scenario.getRows());
            ...
            while (!maze.isGenerated()) {
                ...
                UtilityHelper.logEvent("Maze generation progress: Prims " + maze.getProgress().getProgress());
