...
public class BinaryTreeTest extends MazeTest {
    ...
    public void generate() throws Exception {
        ...
        for (MazeTest.Scenario scenario : MazeTest.Scenario.values()) {
            ...
            //create our maze
            BinaryTree maze = new BinaryTree(scenario.isHexagon(), scenario.getCols(), scenario.getRows());
            ...
            while (!maze.isGenerated()) {
                ...
                UtilityHelper.logEvent("Maze generation progress: BinaryTree " + maze.getProgress().getProgress());
